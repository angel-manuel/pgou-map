import { CALIFICACION, CALIFICACION_COLOR, CALIFICACION_LABEL, CLASIFICACION, CLASIFICACION_COLOR, CLASIFICACION_LABEL, } from "../schema";
export function createLegend(root) {
    return {
        update(mode, derived) {
            root.hidden = false;
            const entries = mode === "clasificacion"
